...
<!--                <li class="searchlist"><div class="searchlistele"><img src="../img/5855735700.jpg"></div><article class="searchcontent"><p>Seaside Town</p><h5>The clouds and sunset glow complement each other and bring out the tranquil atmosphere of the town.The mountains and clouds of the Alps are so fascinating that attracts lots of traveller every year.</h5><ul class="moddel"><li class="del"><button onclick="alert('Delete')">Delete</button></li></ul></article></li>-->
<!--                <li class="searchlist"><div class="searchlistele"><img src="../img/5855735700.jpg"></div><article class="searchcontent"><p>Seaside Town</p><h5>The clouds and sunset glow complement each other and bring out the tranquil atmosphere of the town.The mountains and clouds of the Alps are so fascinating that attracts lots of traveller every year.</h5><ul class="moddel"><li class="del"><button onclick="alert('Delete')">Delete</button></li></ul></article></li>-->
<!--                <li class="searchlist"><div class="searchlistele"><img src="../img/5855735700.jpg"></div><article class="searchcontent"><p>Seaside Town</p><h5>The clouds and sunset glow complement each other and bring out the tranquil atmosphere of the town.The mountains and clouds of the Alps are so fascinating that attracts lots of traveller every year.</h5><ul class="moddel"><li class="del"><button onclick="alert('Delete')">Delete</button></li></ul></article></li>-->
<!--                <li class="searchlist"><div class="searchlistele"><img src="../img/5855735700.jpg"></div><article class="searchcontent"><p>Seaside Town</p><h5>The clouds and sunset glow complement each other and bring out the tranquil atmosphere of the town.The mountains and clouds of the Alps are so fascinating that attracts lots of traveller every year.</h5><ul class="moddel"><li class="del"><button onclick="alert('Delete')">Delete</button></li></ul></article></li>-->
<!--                <li class="searchlist"><div class="searchlistele"><img src="../img/5855735700.jpg"></div><article class="searchcontent"><p>Seaside Town</p><h5>The clouds and sunset glow complement each other and bring out the tranquil atmosphere of the town.The mountains and clouds of the Alps are so fascinating that attracts lots of traveller every year.</h5><ul class="moddel"><li class="del"><button onclick="alert('Delete')">Delete</button></li></ul></article></li>-->
...
<script type="text/javascript">
    ...
    function getMyPhotos() {
        ...
        request.open('POST', '../php/getMyFavors.php');
    ...
    function deleteFavor(obj) {
        let imagesrc = obj.value;

        let request = new XMLHttpRequest();
        request.open('POST', '../php/deleteFavor.php');
        request.setRequestHeader("content-type","application/x-www-form-urlencoded;charset=utf-8");
        let send_data = {
            'src': imagesrc
        }
        ...
        request.onload = function(e){
            ...
            if (request.status === 200 && request.readyState===4) {
                console.log(request.response);
                console.log(typeof(request.response));
                window.location.href="../src/MyFavors.php";
            }
            else{
                alert('设置失败，请重试！');
            }
